import { rigidPcbCapabilitiesContent } from "@/content/rigid-pcb-capabilities-content";
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";

export function RigidPcbCapabilities() {
	const rigidPcbCapabilities = Object.entries(rigidPcbCapabilitiesContent);
	return (
		<>
			{rigidPcbCapabilities.map(([specName, specValue]) => (
				<div key={specName}>
					<Accordion
						type="single"
						collapsible
