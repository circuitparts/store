...
import { selectName, setUploadedFileName, setUploadedFileUrl } from "@/lib/redux/reducers/pcb-assembly-slice";
	...
	async function handleFileUpload(event: MouseEvent<HTMLButtonElement, globalThis.MouseEvent>) {
		startTransition(async () => {
			try {
				...
				handleFileUploadError(error, "UPLOAD ASSEMBLY DESIGN FILE FAULT");
			}
		});
	}
	...
	return (
		<div>
			...
			<div className="flex gap-x-2">
				<Input
					data-testid="pcb-assembly-fab-upload-design-file"
					required
					accept=".zip"
					id="file"
					type="file"
				...
				/>
				<ButtonWithSpinner
					data-testid="pcb-assembly-fab-upload-design-file-button"
					isLoading={isLoading}
					label={"Upload"}
