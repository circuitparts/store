...
import { selectName, setUploadedFileName, setUploadedFileUrl } from "@/lib/redux/reducers/flex-pcb-slice";
	...
	async function handleFileUpload(event: MouseEvent<HTMLButtonElement, globalThis.MouseEvent>) {
		startTransition(async () => {
			try {
				...
				handleFileUploadError(error, "UPLOAD FLEX DESIGN FILE FAULT");
			}
		});
	}
