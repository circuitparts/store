...
import { selectDispatchUnit, selectDispatchUnitOptions, setDispatchUnit } from "@/lib/redux/reducers/rigid-pcb-slice";
import { useDispatch } from "@/lib/redux/store";
import type { RigidPcbDispatchUnitType } from "@/types/rigid-pcb-types";
...
export function DispatchUnit() {
	...
	function handleOnChange(value: RigidPcbDispatchUnitType) {
